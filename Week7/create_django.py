...
lab_path = os.path.abspath(os.path.join(folder_name, "lab_challeng"))
...
print("Next steps, from the 'lab_challeng' folder:")
print(f"  cd {os.path.join(folder_name, 'lab_challeng')}")
print(f"  {activate}")
